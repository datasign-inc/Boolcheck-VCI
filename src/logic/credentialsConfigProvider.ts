...
import affiliationCredential from "./affiliationCredential.js";
...
const issueSdJwtVcCredential: IssueSdJwtVcCredential = async (
  ...
  if (vct === "OrganizationalAffiliationCertificate") {
    return await affiliationCredential.issueAffiliationCredential(
      authorizedCode,
      proofOfPossession.jwt.header.jwk,
    );
  } else {
